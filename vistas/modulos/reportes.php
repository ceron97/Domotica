        ...
        <div class="col-md-4">
          ...
          <div class="card card-widget  widget-user-2" >
            ...
            <div class="card-footer p-0" style="background-color: #343a40; ">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalVentanasRegistradas">
                    ventanas registradas<span class="float-right badge bg-primary">21</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalVentanasEnMalEstado">
                    ventanas en mal estado<span class="float-right badge bg-info">6</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalVentanasVigiladas">
                    ventanas Vigiladas  <span class="float-right badge bg-success">121</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalRegistroDeAccesosVentanas">
          ...
          <div class="card card-widget  widget-user-2" >
            ...
            <div class="card-footer p-0" style="background-color: #343a40; ">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalTemperaturaEnMalEstado">
                    Sensores de Temperatura en mal estado<span class="float-right badge bg-info">5</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalTemperaturaVigilada">
                    Sensores de Temperatura Vigilados  <span class="float-right badge bg-success">12</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalTemperaturaEnFuncion">
        ...
        <div class="col-md-4">
          ...
          <div class="card card-widget  widget-user-2" >
            ...
            <div class="card-footer p-0" style="background-color: #343a40; ">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalServiciosRegistrados">
                    Servicios registrados<span class="float-right badge bg-primary">31</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalServiciosEnMalEstado">
                    Servicios en mal estado<span class="float-right badge bg-info">5</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalServiciosControlados">
                    Servicios Controlados <span class="float-right badge bg-success">12</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalRegistroDeServicios">
        ...
        <div class="col-md-4">
          ...
          <div class="card card-widget  widget-user-2" >
            ...
            <div class="card-footer p-0" style="background-color: #343a40; ">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalIluminacionRegistrada">
                    Bombillos registrados registradas<span class="float-right badge bg-primary">31</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalIluminacionEnMalEstado">
                    Bombillos en mal estado<span class="float-right badge bg-info">5</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalIluminacionControlada">
                    Bombillos Vigiladas  <span class="float-right badge bg-success">12</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link" data-toggle="modal" data-target="#modalRegistroDeIluminacion">
...
<div class="modal fade" id="modalPuertasEnMalEstado">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Puertas En Mal Estado</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <dl class="row">
                    ...
                    <dd class="col-sm-8">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentu justo
                      sit amet risus.
                    </dd>
                  </dl>
                </div>
...
<!-- Puertas vigiladas-->
<div class="modal fade" id="modalPuertasVigiladas">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Puertas Vigiladas</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" id="modalVentanasRegistradas">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Ventanas Registradas</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" id="modalVentanasEnMalEstado">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Ventanas En Mal Estado</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<!-- Ventanas vigiladas-->
<div class="modal fade" id="modalVentanasVigiladas">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Ventanas Vigiladas</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<!-- Registro de accesos-->
<div class="modal fade" id="modalRegistroDeAccesosVentanas">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Historial de Ventanas</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<!--Sensores de temperatura registrados-->
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Sensores Registrados</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" id="modalTemperaturaEnMalEstado">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Sensores en mal Estado</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<!--Sensores de temperatura vigilados-->
<div class="modal fade" id="modalTemperaturaVigilada">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">sensores controlados</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<!--Sensores de temperatura en funcion-->
<div class="modal fade" id="modalTemperaturaEnFuncion">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Sensores en funcion</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" id="modalServiciosRegistrados">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Servicios Registrados</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" id="modalServiciosEnMalEstado">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Servicios En Mal Estado</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" id="modalServiciosControlados">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Servicios Controlados</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<!-- Registro de accesos-->
<div class="modal fade" id="modalRegistroDeServicios">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
...
=================================-->
 ...
 <!-- Bombillos registrados-->
<div class="modal fade" id="modalIluminacionRegistrada">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Bombillos Registrados</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" id="modalIluminacionEnMalEstado">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Bombillos En Mal Estado</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<!-- Bombillos vigilados-->
<div class="modal fade" id="modalIluminacionControlada">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Bombillos Controlados</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<!--Registro de iluminacion y estado-->
<div class="modal fade" id="modalRegistroDeIluminacion">
  <div class="modal-dialog">
    <div class="modal-content" style="background: #6c757d; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!--================================
        ...
        =================================-->
        <div class="modal-header"  style="background: #343a40; color: #fff">
          <h4 class="modal-title">Historial de Iluminacion</h4>
          <button type="button" style="color:red;" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
