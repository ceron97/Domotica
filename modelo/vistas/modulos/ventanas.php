    ...
    <div class="card-body" style="background: #6c757d; color:#fff;">
      ...
      <table class="table table-dark table-striped table-hover dt-responsive tablas " style="width:100%">
        ...
        <tbody style="text-align:center">
          ...
          $ventana = ventanaControlador::ctrMostrarVentana($item, $valor);
          ...
          foreach ($ventana as $key => $value) {
            ...
            echo
              ...
              <td>
                ...
                <button class="btn btnEliminarVentana" idVentana="' . $value["id"] . '" 
                style="border-color: red;color:red;margin:3px"><i class="fa fa-times"></i></button>

                <button class="btn btn-dark btnMostrarVentana" data-toggle="modal" style="border-color: #00FFFF;color:#00FFFF;margin:3px"
                data-target="#modalMostrarVentana"><i class="fas fa-eye"></i></button>
    ...
    <div class="modal-content" style="background: #343a40; color:#fff;">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body" style="background: #7A7878; color:#fff;">
          ...
          $registro = new ventanaControlador();
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content" style="background: #343a40; color:#fff;">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="editarFoto" name="editarFoto">

        <?php

             $editar = new ventanaControlador();
...
<!--  ================================================================
        Modal Mostrar o actualiza imagen ventana
=================================================================  -->
<!-- The Modal -->
<div class="modal fade" id="modalMostrarVentana">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="background: #343a40; color:#fff;">
      <form role="form" method="post" enctype="multipart/form-data">
        <!-- Modal Header -->
        <div class="modal-header">
          ...
          <h4 class="modal-title">Visualización de ventana</h4>
        </div>
        <!-- contenido del modal -->
        <div class="modal-body" style="background: #7A7878; color:#fff;">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <img src="images/ventanas/ventana roto 100.png" class="img-thumbnail previsualizar" width="200px" height="200px">
